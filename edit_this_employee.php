...
$pid = $_GET['id'];
 ...
 $query = "select * from departments inner join employees on departments.id=employees.department_id inner join person on employees.person_id=person.id WHERE person_id = '$pid' LIMIT 1";
